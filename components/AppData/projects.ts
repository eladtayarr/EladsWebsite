const PROJECTS_DATA = [
  {
    ...
    description: 'Crafting the future with innovation and creativity. Explore my journey.',
    about:
  ...
  {
    title: 'OLE-pâtisserie',
    description:
      'Building a web information system that includes connectivity to a database and connection of several types of users.',
  ...
  },
  {
    ...
    description: 'Master the basics of data structures and algorithms to design efficient, data-driven software.',
